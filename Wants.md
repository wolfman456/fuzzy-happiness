...
- As a Player I want a polished sign-in/sign-up page with a themed background so the entry screen feels part of the game. (R15) 🔨 in progress
- As a Player I want to confirm my password twice on registration so typos don't lock me out. (R16) 🔨 in progress
- As a Player I want to supply my real name separately from my username and display name so I can be addressed properly without exposing my account handle. (R17) 🔨 in progress
- As a Player I want my personal details (email, names, date of birth) encrypted at rest so a database leak doesn't expose my identity. (R18) 🔨 in progress
...
- As an admin I want the production database seeded with a bootstrap administrator so I can administer the platform from day one. (R20) 🔨 in progress
