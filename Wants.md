...
- As a Player I want a themed backdrop across all screens of the app — not empty white pages — so the whole app feels part of the game rather than a form tool. (R29) 🔨 in progress
- As a Player I want the app's navigation tucked into a slide-in sidebar that opens from a menu button in the top bar, so screens stay uncluttered and the top header stays slim. (R30) 🔨 in progress
