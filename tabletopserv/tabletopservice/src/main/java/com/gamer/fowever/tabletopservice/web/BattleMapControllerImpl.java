...
import com.gamer.fowever.tabletopapi.BattleMapApi;
...
import com.gamer.fowever.tabletopservice.service.BattleMapService;
...
public class BattleMapControllerImpl implements BattleMapApi {

    private final BattleMapService battleMapService;

    public BattleMapControllerImpl(BattleMapService battleMapService) {
