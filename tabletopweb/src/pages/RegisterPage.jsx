...
export default function RegisterPage() {
  ...
  function validate() {
    ...
    if (!form.realName.trim()) nextFields.realName = 'Your real name is required.'
    ...
    if (form.password !== form.confirmPassword) {
      nextFields.confirmPassword = 'Passwords do not match.'
    }
    ...
    <AuthBackground>
      <div className="mx-auto w-full max-w-md rounded-xl border border-zinc-700 bg-zinc-100 p-8 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <Field label="Real name" id="realName" error={fields.realName}>
            <input
              id="realName"
              type="text"
              autoComplete="name"
            ...
            <span className="mt-1 block text-xs text-zinc-500">
              Used for your place at the table. Only you and the organizer see it.
            </span>
          </Field>
          ...
          <Field label="Confirm password" id="confirmPassword" error={fields.confirmPassword}>
            <input
              id="confirmPassword"
              type="password"
              autoComplete="new-password"
